...
function registerStatusBar(context) {
    ...
    const alphaVersion = alphaInstaller_1.getPersistedAlphaVersion(context);
    statusBarData = new StatusBarData_1.default(statusBar);
    statusBar.command = commandsHandler_1.STATUS_BAR_COMMAND;
    statusBar.tooltip = `${consts_1.FULL_BRAND_REPRESENTATION} (Click to open settings)${alphaVersion !== null && alphaVersion !== void 0 ? alphaVersion : ""}`;
    statusBar.show();
