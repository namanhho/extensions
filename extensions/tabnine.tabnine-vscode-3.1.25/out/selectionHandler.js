...
exports.handleImports = exports.selectionHandler = exports.HANDLE_IMPORTS = exports.COMPLETION_IMPORTS = void 0;
...
function selectionHandler(editor, edit, { currentCompletion, completions, position }) {
    try {
        ...
        void vscode_1.commands.executeCommand(exports.HANDLE_IMPORTS, { completion: currentCompletion });
    }
    catch (error) {
        console.error(error);
    }
...
function handleState(position, completions, currentCompletion, editor) {
