...
function handleSelection(context) {
    if (extensionContext_1.tabnineContext.isTabNineAutoImportEnabled) {
        context.subscriptions.push(vscode.commands.registerTextEditorCommand(selectionHandler_1.COMPLETION_IMPORTS, selectionHandler_1.selectionHandler), vscode.commands.registerTextEditorCommand(selectionHandler_1.HANDLE_IMPORTS, selectionHandler_1.handleImports));
    }
}
